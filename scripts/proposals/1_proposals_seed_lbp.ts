...
async function main() {
  ...
  let createPollMsg = {
    create_poll: {
      ...
      description:
        "This proposal will initiate and seed Nebula's liquidity bootstrapping pool (LBP) using 20 million NEB tokens and 1 million UST from the community pool. The pool will have a starting NEB-UST weight of 98-2 and ends at a 40-60 weight over 5 days.",
